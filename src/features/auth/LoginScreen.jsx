...
function LoginScreen() {
  ...
  function handlePhoneContinue() {
    ...
    setError('');
    navigate('/otp', { state: { identity: phone, from: returnTo } });
  }
  ...
  function handleEmailContinue() {
    ...
    setError('');
    const isNew = !isKnownIdentity(email);
    if (isNew) {
      navigate('/register', { state: { identity: email, method: 'email', from: returnTo } });
    } else {
      navigate('/otp', { state: { identity: email, method: 'email', from: returnTo, skipOtp: true, name: '' } });
    }
  }
